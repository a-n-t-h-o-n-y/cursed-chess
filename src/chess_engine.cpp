...
const State& Chess_engine::state() const { return state_; }

chess::State& Chess_engine::state() { return state_; }

Player* Chess_engine::player_black() const { return player_black_.get(); }

Player* Chess_engine::player_white() const { return player_white_.get(); }
